...
using PyramidSlideDown;

namespace PyramidSlideDownTests
{
    [TestClass]
    public class UnitTest1
    {
        ...
        public void SmallPyramidTest()
        {
            ...
            Assert.AreEqual(23, PyramidSlideDown.PyramidSlideDown.LongestSlideDown(smallPyramid));
        }
        ...
        public void MediumPyramidTest()
        {
            ...
            Assert.AreEqual(1074, PyramidSlideDown.PyramidSlideDown.LongestSlideDown(mediumPyramid));
        }
    }
}
